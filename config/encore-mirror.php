...
return [
    /* Source storefront used to build the Laravel copy. */
    ...
    /* Theme CSS/JS and web-font downloads may need longer than page requests. */
    ...
    /*
    | CSS, JavaScript and the web-font files they reference are mirrored locally.
    | Images and video remain on the source storefront, avoiding duplicate media.
    |
